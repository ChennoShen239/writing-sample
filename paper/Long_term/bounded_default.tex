...
I maintain primitives, debt structure, and the sovereign aggregator $J_\rho$ and
use the pricing operator in Definition~\ref{def:pricing_operator}. Only the
...
Appendix~\ref{app:operator_analysis}, I restrict $\theta\in[1,\bar\theta]$ for a
finite $\bar\theta>1$.

\paragraph{Information structure}
Each period, competitive lenders observe two public signals: a mean/fundamentals
signal and a dispersion/stability signal,
\[
...
reduced the credibility of official signals. From
